...
using System;
using System.Data;
using static WpfApplication.Utilities.Enums;

namespace WpfApplication.ViewModel
{
    public partial class FilterVM : ObservableRecipient
    {
        ...
        public FilterVM(DataGrid dataGrid, int columnIndex, string startFilterMode, ref ObservableCollection<ObservableCollection<FilterCondition>> columnFilterConditions, bool isNumericalColumn)
        {
        ...
        public void RemoveFilter(ListView filterListView)
        {
            ...
            if (FilterConditions.Count > 0)
            {
                FilterCondition firstCondition = filterListView.Items[0] as FilterCondition;
